...
/* harmony import */ var _EcontDelivery__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./EcontDelivery */ "./src/blocks/checkout/EcontDelivery.js");
...
const EcontShippingContent = () => {
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_EcontDelivery__WEBPACK_IMPORTED_MODULE_5__["default"], null);
};
...
if (!isPluginActive || !isPluginActive('econt-always-loaded')) {
  (0,_wordpress_plugins__WEBPACK_IMPORTED_MODULE_2__.registerPlugin)('econt-always-loaded', {
    render: EcontAlwaysLoadedContent,
    scope: 'woocommerce-checkout'
  });
}
if (!isPluginActive || !isPluginActive('econt-cart-always-loaded')) {
  (0,_wordpress_plugins__WEBPACK_IMPORTED_MODULE_2__.registerPlugin)('econt-cart-always-loaded', {
    render: EcontAlwaysLoadedContent,
