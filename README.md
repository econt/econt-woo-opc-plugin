...
| **[🎨 Скриване на полета](https://github.com/econt/econt-woo-opc-plugin/wiki/Field-Hiding-Guide.md)** | Персонализиране на checkout полета **(НОВО v3.0.4)** | 10 мин |
| **[✅ Проверка на статуса](https://github.com/econt/econt-woo-opc-plugin/wiki/СТАТУС_ПРОВЕРКА_ДОКУМЕНТАЦИЯ.md)** | Диагностика и проверка на конфигурацията **(НОВО v3.0.5)** | 5 мин |
